...
# duplicate frequency is found, and that duplicates might be found while in 
...
setwd("/home/hfg/Documents/hfg_soft/misc/misc_projects/advent_of_code/")

dat <- scan("day1_data.txt")